...
candleLight3.position.set(0, 5, 0);
candleLight3.castShadow = true;
caseMesh.add(candleLight3);


var candleLight4 = new THREE.PointLight(0xffaa33, 1, 5, 2);
candleLight4.position.set(0, 6, 0);
candleLight4.castShadow = true;
caseMesh.add(candleLight4);


var candleLight5 = new THREE.PointLight(0xffaa33, 1, 50, 1);
candleLight5.position.set(0, 20, 0);
candleLight5.castShadow = true;
caseMesh.add(candleLight5);
*/
